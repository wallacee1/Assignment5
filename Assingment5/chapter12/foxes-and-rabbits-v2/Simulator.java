...
public class Simulator
{
    ...
    // The probability that a Mountain Lion will be created in any given grid position.
    private static final double MOUNTAINLION_CREATION_PROBABILITY = 0.3;
